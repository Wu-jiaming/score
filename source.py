...
def makeDate(second, minute, hour, day, month, year, count):
    dates = []
    for i in range(100):
        second = second + 10
        minute = minute + 30
    ...
    count = count + 1
    return (logs, second, minute, hour, day, month, year)
...
if __name__ == '__main__':
    ...
    count = 1
    for i in range(20):
        with open('source2.txt', 'a+', encoding='utf-8') as f:
            #for i in range(len(logs)):
            t = makeDate(second, minute, hour, day, month, year, count)
            f.writelines(line + '\n' for line in t[0])
            second = t[1]
            minute = t[2]
            hour = t[3]
